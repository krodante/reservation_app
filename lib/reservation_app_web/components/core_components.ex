defmodule ReservationAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ReservationAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ReservationAppWeb.Gettext, "errors", msg, opts)
    end
  end
